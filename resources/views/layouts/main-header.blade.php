								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<a href="\MarkAsRead_all"></a> تحديد الكل كمقروء</span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك {{ auth()->user()->unreadNotifications->count() }} اشعارات جديدة</p>
